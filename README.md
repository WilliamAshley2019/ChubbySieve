...
Various versions of this plugin Exist
It is still a work in progress. 

Just a little info on the plugin design, it started as a type of chebyshev polynomial enhancer which to my understanding can add harmonic content.
I however added a bitmore than that to it, full readme coming once finalized, "testing done"
